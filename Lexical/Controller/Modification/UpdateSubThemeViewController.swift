//
//  UpdateSubThemeViewController.swift
//  Lexical
//
...
class UpdateSubThemeViewController: UIViewController, iCarouselDelegate, iCarouselDataSource, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    
    
    @IBOutlet weak var lblName: UILabel!
    @IBOutlet weak var lblDescription: UILabel!
    @IBOutlet weak var btnBack: UIBarButtonItem!
    @IBOutlet weak var btnUpdateSubTheme: UIBarButtonItem!
