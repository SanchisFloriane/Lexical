...
class UpdateWordViewController: UIViewController, iCarouselDelegate, iCarouselDataSource, UIImagePickerControllerDelegate, UINavigationControllerDelegate
{
    
    @IBOutlet weak var lblNameWord: UILabel!
    @IBOutlet weak var lblTraduction: UILabel!
    @IBOutlet weak var btnBack: UIBarButtonItem!
    @IBOutlet weak var btnUpdateWord: UIBarButtonItem!
